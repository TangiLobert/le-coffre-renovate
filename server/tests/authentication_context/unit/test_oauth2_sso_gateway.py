"""Tests for the Authlib implementation of the SSO Gateway."""
...
class TestOAuth2SsoGateway:
    """Tests for OAuth2SsoGateway."""
    ...
    def test_configure_with_google_endpoints(self, gateway):
        ...
        assert (
            gateway._userinfo_endpoint
            == "https://www.googleapis.com/oauth2/v2/userinfo"
        )

    def test_configure_with_microsoft_endpoints(self, gateway):
    ...
    def test_configure_with_custom_provider(self, gateway):
    ...
    @pytest.mark.asyncio
    async def test_validate_callback_missing_endpoints(self):
        ...
        with pytest.raises(
            ValueError, match="Token and userinfo endpoints not configured"
        ):
